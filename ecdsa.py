...
# inspired from https://github.com/andreacorbellini/ecc/blob/master/scripts/ecdsa.py
...
class ECDSA_key:
    ...
    def point_add(self, point1, point2):
        ...
        if x1 == x2:
            ...
            #print(x1-x2)
            #print(self.p)
            #print("mod_inv renvoie "+str(utils.mod_inv(x1 - x2, self.p, 0)))
